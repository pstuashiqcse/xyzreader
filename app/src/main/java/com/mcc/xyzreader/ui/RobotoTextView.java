...
public class RobotoTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void init() {
        Typeface regularFont = Typeface.createFromAsset(getContext().getAssets(), "Roboto-Regular.ttf");
        Typeface boldFont = Typeface.createFromAsset(getContext().getAssets(), "Roboto-Bold.ttf");
